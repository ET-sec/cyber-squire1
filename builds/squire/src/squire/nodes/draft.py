"""draft node - Fable 5 IR report drafter with citation allow-list retry.
...
def _build_context(state: dict) -> dict[str, Any]:
    """Bounded context pack fed into the Fable call."""
    investigation_rows = [
...
def draft_report(state: dict) -> dict:
    """Fable 5 draft node with citation allow-list retry (criterion #17)."""
