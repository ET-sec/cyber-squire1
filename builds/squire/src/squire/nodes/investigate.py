"""investigate node - Opus 4.8 investigation synthesis with Tavily follow-up.
...
After classification + retrieval + enrichment, this node:
  ...
  2. Asks Opus 4.8 to synthesize an investigation plan: what's been checked,
...
def investigate(state: dict) -> dict:
    """Opus 4.8 investigation synthesis node.
