"""YouTube metadata content generator."""
...
def generate_youtube(
    ...
    """Generate YouTube metadata (titles, description, tags, thumbnails) and save to file."""
    ...
    output_path = output_dir / "youtube_metadata.md"
