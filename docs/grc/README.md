...
Documentation for the Squire autonomous SOC analyst: LangGraph 7-node state machine with pgvector RAG, Fable 5 primary and Sonnet 4.6 routing, NeMo Guardrails v0.21.0 sidecar, Langfuse v3 observability. Ten documents covering compliance, risk, red-team, and governance.
...
| [SQUIRE_MODEL_CARD.md](SQUIRE_MODEL_CARD.md) | Mitchell et al. model card - Fable 5 primary plus Sonnet 4.6 classifier plus Voyage AI voyage-3-large embeddings, intended use, evaluation data, ethical considerations, limitations, provenance |
