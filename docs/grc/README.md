...
- **NIST SP 800-53 Rev. 5** - Moderate baseline, 17 control families
...
| Document | Description |
|----------|-------------|
| [DATA_FLOW_DIAGRAM.md](DATA_FLOW_DIAGRAM.md) | DFD Levels 0 through 2, 40 data flows, 15 data stores, 14 external entities, 8 trust boundaries |
...
- **42 POA&M entries** tracked (27 base plus 15 Phase 17: 14 accepted risk, 19 open, 9 closed)
...
- **40 data flows** mapped across **8 trust boundaries** (the Phase 17 flows cross boundaries the model already defines)
...
- **2 tabletop exercises**: a 5-phase compromised-container scenario and the Squire jailbreak and containment exercise
