...
Documentation for the Squire autonomous SOC analyst: LangGraph 7-node state machine with pgvector RAG, Fable 5 primary and Sonnet 4.6 classification, NeMo Guardrails v0.21.0 sidecar, Langfuse v3 observability. Twelve documents covering compliance, risk, threat modeling, red-team, exercises, and governance.
